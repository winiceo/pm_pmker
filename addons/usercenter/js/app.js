var releaseVer = '111519,382433374';
...
(function(){
  var alias = {
    ...
    'pageNavJeff':'public/ui/pageNavJeff/factory',
    ...
    'swiper': 'public/ui/swiper/factory',
    //util
    ...
    'filedrop': 'public/util/filedrop/filedrop-min',
    'exUploader':'public/util/exUploader/factory',
  ...
  seajs.config({
    alias: alias,
    base: '/public/addons/usercenter/',
    root: 'https://weixin.drip.im/',
    map: [
